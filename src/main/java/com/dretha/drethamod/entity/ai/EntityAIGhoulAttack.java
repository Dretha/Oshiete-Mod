...
public class EntityAIGhoulAttack extends EntityAIBase
{
    World world;
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            if (canPenalize)
            {
                ...
                {
                    this.path = this.attacker.getNavigator().getPathToEntityLiving(base);
            ...
            {
                return this.getAttackReachSqr(base) >= this.attacker.getDistanceSq(base.posX, base.getEntityBoundingBox().minY, base.posZ);
            }
        }
    }
