...
import com.dretha.drethamod.entity.projectile.RCShard;
...
public abstract class RenderRCShardBase<T extends RCShard> extends Render<T>
{
    public RenderRCShardBase(RenderManager renderManagerIn)
    {
