...
public abstract class RCShard extends Entity implements IProjectile
{
    ...
    protected static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(RCShard.class, DataSerializers.BYTE);
    protected int xTile;
    protected int yTile;
    protected int zTile;
    ...
    public RCShard.PickupStatus pickupStatus;
    ...
    public RCShard(World worldIn)
    {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = RCShard.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
        this.setSize(0.5F, 0.5F);
    }

    public RCShard(World worldIn, double x, double y, double z)
    {
        this(worldIn);
        this.setPosition(x, y, z);
    }

    public RCShard(World worldIn, EntityLivingBase shooter)
    {
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == RCShard.PickupStatus.ALLOWED)
                    {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = RCShard.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? RCShard.PickupStatus.ALLOWED : RCShard.PickupStatus.DISALLOWED;
        }
    ...
    public static enum PickupStatus
    {
        ...
        public static RCShard.PickupStatus getByOrdinal(int ordinal)
        {
