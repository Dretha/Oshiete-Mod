...
public class LayerShardEntity implements LayerRenderer<EntityLivingBase>
{
    private final RenderLivingBase<?> renderer;

    public LayerShardEntity(RenderLivingBase<?> rendererIn)
    {
	...
	public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        i = EventsHandler.getCapaMP((EntityPlayer)entitylivingbaseIn).getShardCountInEntity();
		}
