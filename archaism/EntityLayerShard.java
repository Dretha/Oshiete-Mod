...
public class EntityLayerShard implements LayerRenderer<EntityLivingBase>
{
    private final RenderLivingBase<?> renderer;

    public EntityLayerShard(RenderLivingBase<?> rendererIn)
    {
    ...
    {
		int i = 0;
		if (entitylivingbaseIn instanceof EntityHuman) {
			i = ((EntityHuman) entitylivingbaseIn).getShardCount();
		}

        if (i > 0) {
            Entity entity = new EntityRCShard(entitylivingbaseIn.world, entitylivingbaseIn.posX, entitylivingbaseIn.posY, entitylivingbaseIn.posZ);
